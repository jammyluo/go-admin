...
type Goods struct {
	...
	ItemLink         string    `json:"itemLink" xorm:"not null default '' comment('淘宝标题') VARCHAR(200)"`
	...
	CommissionRate   int       `json:"commissionRate" xorm:"not null default 1 comment('佣金比例') INT(11)"`
	CouponLink       string    `json:"couponLink" xorm:"not null comment('优惠券使用条件') VARCHAR(20)"`
	CouponStartTime  time.Time `json:"couponStartTime" xorm:"not null default '0000-00-00 00:00:00' comment('优惠券开始时间') DATETIME"`
	CouponEndTime    time.Time `json:"couponEndTime" xorm:"not null default '0000-00-00 00:00:00' comment('优惠券结束时间') DATETIME"`
